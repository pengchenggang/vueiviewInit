...
/**
 * @functionName MessageZen
 * @param 提示信息
 * @return 无
 * @description 提示信息 每次弹一条 再弹关闭上一条信息
 * @author 彭成刚
 * @date 2019-10-22 11:38:00
 * @version V1.0.0
 */
export const MessageZen = {
  info (str) {
    let _initParam = this._init(str)
    Message.info({
      ...this._params,
      ..._initParam
    })
